 ...
 */
const empty = { enabled: false, base_url: "https://ia.mginformatique.com", model: "qwen2.5", api_key: "", has_api_key: false };
  ...
  return (
    <div className="p-4 max-w-2xl">
      ...
      <p className="text-sm text-muted-foreground mb-4">
        Connexion au modèle utilisé par la recherche IA avancée — un déploiement Qwen auto-hébergé, accessible en WAN.
      </p>
