"""Plugin Object Detection — OpenVINO (Intel).
...
class OpenVinoPlugin(FrameAnalyzer):
    name = "openvino-detector"
    version = "1.0.0"
    ...
    def _evaluate_state(self):
        ...
        try:
            ...
            self._ctx.set_state("missing_dependency", "pip install openvino")
            return
