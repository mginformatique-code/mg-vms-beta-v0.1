"""Plugin Object Detection — YOLO-NAS (Deci AI).
...
class YoloNasPlugin(FrameAnalyzer):
    name = "yolo-nas"
    version = "1.0.0"
    ...
    def _evaluate_state(self):
        ...
        # Détection deps
        try:
            from super_gradients.training import models  # noqa
        except ImportError:
            self._ctx.set_state("missing_dependency", "pip install super-gradients")
            return
