"""Plugin Object Detection — EfficientDet (Google).
...
class EfficientDetPlugin(FrameAnalyzer):
    name = "efficientdet"
    version = "1.0.0"
    ...
    def _evaluate_state(self):
        ...
        try:
            ...
            self._ctx.set_state("missing_dependency", "pip install effdet torch torchvision")
            return
